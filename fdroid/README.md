...
The release work is stacked as PR #2 -> PR #5 -> PR #7. Merge that stack in order. Do not create the Android release tag on a branch-only commit. After PR #7 has landed on `cayley`, tag the exact integrated release commit `android-v0.1.0`.
